    ...
    data.forEach(function (game) {
      ...
      img.addEventListener("click", async function () {
        ...
        if (selectedGame === game.name) {
          ...
          function loadClip(clipPointer) {
            clipsContainerContainer.innerHTML = "";
            ...
            if (clipPointer > 0) {
              ...
              prevClipButton.classList.add('disabled');
            }
            ...
            if (clipPointer > 0) {
              ...
              nextClipButton.classList.add('disabled');
            }
